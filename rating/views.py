...
def compare(request):
        ...
        return render(request, 'rating/compare.html', {'ac_all': ac_all, 'months': months, 'groups': groups, 'age': age})
...
def score(request):
    ...
    return render(request, 'rating/score.html', {'months': months, 'age': age})
